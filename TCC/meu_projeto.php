<?php
  ...
  /*if (($result_arquivos) and ($result_arquivos->rowCount() != 0)) {
    while ($row_arquivo = $result_arquivos->fetch(PDO::FETCH_ASSOC)) {
      var_dump($_SESSION['projeto_link']);
    }
  } else {
  ...
  <body>
    ...
    <div class="container-all">
      ...
      <div class="container-body">
        ...
        <div class="conteudo">
          <div class="conte">MEUS PROJETOS</div>
          <div class="container-documentos">

                <?php

                $filtro = $pdo->prepare("SELECT id_instituicao, codigo_projeto, projeto_link, titulo_projeto, ano_producao, curso, nomes_integrantes, resumo, nome_categoria FROM projeto WHERE email_institucional_aluno=?");
                $filtro->execute(array($_SESSION['email_institucional_aluno']));
              ...
              <div class="box_projeto">
                ...
                <?php 
                    ...
                    echo "<p> Você ainda não possui projetos cadastrados!";
                  }
                ?>
          </div>
